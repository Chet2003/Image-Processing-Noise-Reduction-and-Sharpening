...
- **General Format:** a3.py algType kernSize param inFileName outFileName 
- **algType:** Indicates the image processing algorithm. Utilize -s (sharpen) or -n (noise removal) 
...
- **Example of Command Line Arguments:**  
  - a3.py -n 3 0 noise_1.jpg noise_1NoiseReduct.jpg
